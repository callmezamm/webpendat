...
with implementation:
    ...
    radius_mean = st.number_input("Masukkan Rata-rata Radius", min_value=6.98, max_value=28.1)
    texture_mean = st.number_input("Masukkan rata-rata Texture", min_value=9.71, max_value=39.3)
    perimeter_mean = st.number_input("Masukkan rata-rata perimeter", min_value=43.8, max_value=189.0)
    area_mean = st.number_input("Masukkan rata-rata area", min_value=144, max_value=2500)
    smoothness_mean = st.number_input("Masukkan Rata-rata Smothness", min_value=0.05, max_value=0.16)
    compactness_mean = st.number_input("Masukkan rata-rata compactness", min_value=0.02, max_value=0.35)
    concative_mean = st.number_input("Masukkan rata-rata concative", min_value=0.0, max_value=0.43)
    concave_point_mean = st.number_input("Masukkan rata-rata concave point", min_value=0.0, max_value=0.2)
